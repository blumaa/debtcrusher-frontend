...
export const postProject = project => {
  ...
  return async dispatch => {
    try {
      ...
      const response = await fetch('https://debt-crusher-backend.herokuapp.com/api/projects', reqObj)
...
export const fetchProjects = () => {
  ...
  return async dispatch => {
    try {
      const response = await fetch('https://debt-crusher-backend.herokuapp.com/api/projects')
      const json = await response.json()
